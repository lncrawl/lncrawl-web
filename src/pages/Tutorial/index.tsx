  ...
  const items: CollapseProps['items'] = [
    {
      ...
      children: (
        <div>
          ...
          <Paragraph>
            This application helps you crawl, organize, and read light novels
            from various supported sources. Follow this guide to learn how to
          ...
          <ul>
            <li>
              <Text strong>My Requests:</Text> View and manage all novel
              requests that you have submitted. This is the default view for
              regular users.
            </li>
            <li>
        ...
        <div>
          ...
          <ol>
            ...
            <li>
              ...
              at the top of the page, and click the submit button or press
              Enter.
            </li>
            <li>
            ...
            <li>
              ...
              You can switch to the <Text strong>"All Requests"</Text> tab to
      ...
      children: (
        <div>
          ...
          <Paragraph>
            ...
            use filters to search by title or source, and click any novel to
            view its details.
          </Paragraph>
          ...
          <ul>
            ...
            <li>
              ...
              organized hierarchically. Click chapter titles to read, or use
              "Get" to fetch unavailable chapters. The "Download All" button
              fetches all content at once. Read chapters appear dimmed to track
              progress.
            </li>
            <li>
              <Text strong>Artifacts:</Text> View and download generated e-books
              (EPUB, PDF, MOBI, etc). Click "Make Artifact" to create
              downloadable files in your preferred formats.
            </li>
          </ul>
      ...
      children: (
        <div>
          ...
          <ul>
            ...
            <li>
              <Text strong>Settings:</Text> Click the settings icon to
              customize:
              <ul>
            ...
            <li>
              <Text strong>Table of Contents:</Text> Access the chapter list
              from within the reader.
            </li>
          </ul>
        </div>
      ),
    },
    {
      ...
      children: (
        <div>
          ...
          <Paragraph>
            <Text type="secondary">
              Tip: Artifact generation may take some time depending on the
              novel's size. You can check the request status from the request
              details page.
            </Text>
          </Paragraph>
        </div>
        ...
        <div>
          ...
          {!isLocalUser && (
            <>
              ...
              <Paragraph>
                Configure email notifications for various events. Toggle each
                option on or off:
              </Paragraph>
              <ul>
                <li>
                  <Text strong>On novel fetch request success:</Text> Receive an
                  email when a novel has been successfully fetched and is ready
                  to read.
                </li>
                <li>
                  <Text strong>On artifact create request success:</Text> Get
                  notified when an artifact (EPUB, PDF, MOBI, etc.) has been
                  successfully generated and is ready for download.
                </li>
                <li>
                  <Text strong>When any request starts running:</Text> Be
                  notified when any request (novel fetch, artifact generation,
                  etc.) begins processing.
                </li>
                <li>
                ...
                <li>
                  <Text strong>When any request failed:</Text> Get alerted when
                  a request fails, so you can take action or retry.
                </li>
                <li>
                  <Text strong>When any request canceled:</Text> Be notified if
                  you or the system cancels a running request.
                </li>
              </ul>
              <Text type="warning">
          ...
          <Paragraph>
            Customize your reading experience with these settings. They are
            saved as defaults and applied when you open the reader, but you can
            adjust them per session:
          </Paragraph>
          <ul>
            <li>
              <Text strong>Theme:</Text> Choose from various color schemes
              (light, dark, and other themes) for the reader background and
              text. Select the theme that's most comfortable for your eyes.
            </li>
            <li>
              <Text strong>Font Family:</Text> Select your preferred font from
              available options. Different fonts can improve readability based
              on your preference and device.
            </li>
            <li>
            ...
            <li>
              ...
              more breathing room, while lower values fit more text. Adjust
              based on your reading comfort.
            </li>
            <li>
              <Text strong>Voice:</Text> Select a text-to-speech voice from your
              browser's available voices. This enables the reader to read
              chapters aloud. Note: Requires browser support for speech
              synthesis.
            </li>
            <li>
            ...
            <li>
              <Text strong>Speed:</Text> Control how fast the text-to-speech
              voice reads using a slider (range: 0.1 to 2.0). Increase for
              faster reading or decrease for slower, more careful narration.
            </li>
            <li>
      ...
      : [
          {
            ...
            children: (
              <div>
                ...
                <ul>
                  <li>
                    <Text strong>Change Name:</Text> Click "Edit" next to your
                    name, enter a new display name (min 2 characters), and save.
                  </li>
                  <li>
                    <Text strong>Change Password:</Text> Click "Change
                    Password", enter your current and new password (min 6
                    characters), then update.
                  </li>
                  <li>
                    <Text strong>Token:</Text> Generate tokens and share them
                    with the new users for allowing them to signup.
                  </li>
                </ul>
                ...
                <Paragraph>
                  ...
                  security. If unverified, you'll see a "Verify Email" button in
                  the sidebar.
                </Paragraph>
                <ol>
                  <li>Click "Verify Email" button.</li>
                  <li>
                    Check your email for a 6-digit code (check spam folder if
                    needed).
                  </li>
                  <li>Enter the code in the verification modal.</li>
                  <li>
                    Click "Verify" to complete. Resend is available after 30
                    seconds.
                  </li>
                </ol>
                <Paragraph>
                  <Text type="secondary">
                    ...
                    <Link to="/settings">Settings</Link>), improve account
                    security, and allow you to receive important updates.
                  </Text>
                </Paragraph>
              </div>
            ),
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              <Link to="/meta/sources">Crawlers page</Link> to see the full
              list.
            </li>
            <li>
            ...
            {!isLocalUser && (
              <li>
                <Text strong>Feedback:</Text> Found a bug or have a suggestion?
                Use the <Link to="/feedbacks">Feedbacks page</Link> to report
                issues or share ideas.
              </li>
            )}
          </ul>
        </div>
